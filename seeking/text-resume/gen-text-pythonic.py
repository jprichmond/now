...
d = [0, 2, 3, 2, 1, 7, 6, 2, 1, 2, 4, 2, 1, 2, 3, 3, 4, 2, 3, 2, 2, 2, 1,
     2, 3, 2, 1, 2, 3, 2, 1, 2, 2, 2, 2, 2, 1, 2, 4, 2, 1, 2, 3, 3, 1, 2, 3, 2]
...
w = web.employing
left_column += [f'''{em.upper()}:{(cl-len(em+':'))*' '}{gut*' '}''',
...
# UNDERGRAD ###################################################################################################
un = ed.undergrad
maj = f'''{un.major.anth.title()}, {un.major.ling.title()}, {un.major.econ.title()}'''
